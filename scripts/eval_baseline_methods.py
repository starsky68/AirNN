...
def main(args):
    ...
    logger.info("Jingjinji:")
    # eval_dcrnn(r"../data/test_bj_prediction.npz")
    # eval_chebcrnn(r"../data/test_bj_prediction.npz")
    # eval_fcrnn(r"../data/test_bj_prediction.npz")
    eval_gcrnn(r"../data/YM4AQP_BJ_outtest_random_walk_pool_size4_CELL2_withoutsprase_4transdrop0.3_droppathin_sq_prediction.npz")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--temperature_filename',
                        default="../data/BeiJing/Jingjinji_poll/Jingjinji_data.npy",
                        type=str,
