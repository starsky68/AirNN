...
if __name__ == "__main__":
    ...
    parser.add_argument('--station_ids_filename', type=str, default='Beijing_graph_station_ids',
                        help='File containing station ids separated by comma.')
    parser.add_argument('--distances_filename', type=str, default='bj_distances_station.csv',
    ...
    parser.add_argument('--output_pkl_filename', type=str, default='Beijing_adj_mat.pkl',
    ...
    print(station_id_to_ind,'0000000000')
    # Save to pickle file.
